...
const Particion = () => {
    ...
    const menuOptions = [
        {
            id: 'community',
            title: 'Algoritmo Communidad',
            description: 'Implementación estándar del algoritmo de partición',
            icon: <img src={mercedesImg} alt="Mercedes" className="w-100 h-60 mx-auto" />,
        ...
        },
        {
            ...
            description: 'Implementación personalizada y optimizada del algoritmo de partición',
            icon: <img src={ferrariImg} alt="Ferrari" className="w-100 h-60 mx-auto" />,
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-6">
            <div className="max-w-4xl w-full">
              ...
              `}></div>
                            ...
                            {/* Card content */}
                            <div className="
                relative bg-slate-800/80 backdrop-blur-xl rounded-2xl p-8 h-full
