...
const HamiltonianMenu = () => {
    ...
    const menuOptions = [
        {
            id: 'community',
            title: 'Algoritmo Community',
            description: 'Implementación estándar del algoritmo hamiltoniano',
            icon: '🌐',
        ...
        },
        {
            ...
            description: 'Implementación personalizada y optimizada del algoritmo hamiltoniano',
            icon: '⚡',
