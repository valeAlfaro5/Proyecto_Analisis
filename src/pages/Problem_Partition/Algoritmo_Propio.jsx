...
function Algoritmo_Propio() {
  ...
  const backgroundClasses = "min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900 flex ";
  ...
  return (
    ...
    <div className="p-6 max-w-5xl mx-auto">
      <h1 className="text-4xl font-bold bg-gradient-to-r from-red-500 to-yellow-400 bg-clip-text text-transparent pb-10 mb-10">
          🏎️ Balanceador De Peso F1 OWN
      </h1>
      ...
      <div className="text-center mt-10 pt-10">
        <Link
          to="/particion"
          className={`group inline-flex items-center space-x-4 px-8 py-4 text-lg font-bold text-white/80 rounded-full border-2 border-white/20 hover:border-red/40 hover:text-red-500 backdrop-blur-lg bg-red/5 hover:bg-red/10 transition-all duration-500 hover:scale-105`}
          style={{ transitionDelay: '0.3s' }}
        >
          <div className="w-8 h-8 rounded-full bg-amber-700/20 flex items-center justify-center group-hover:bg-amber-950/30 transition-colors duration-300">
            <div className="w-0 h-0 border-r-4 border-r-amber-700 border-y-2 border-y-transparent mr-1"></div>
          </div>
